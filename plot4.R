...
##voltage
with(powerdata, plot(datetime, voltage, ylab = "Voltage", xlab = "Time", type = "l"))
...
with(powerdata, plot(datetime, global_reactive_power, ylab = "Global Reactivity Power", xlab = "Time", type = "l"))
